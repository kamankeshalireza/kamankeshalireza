...
[![Telegram](https://img.shields.io/badge/Telegram-@alireza_kamankesh-26A5E4?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/alireza_kamankesh)
...
```python
class AlirezaKamankesh:
    def __init__(self):
        self.name = "Alireza Kamankesh"
        self.role = "Full-Stack Web Developer"
        self.education = "Computer Engineering Student"
        self.location = "Iran 🇮🇷"
        self.website = "https://alirezakamankesh.pythonanywhere.com"
        self.hobbies = ["Coding 💻", "AI 🤖", "Reading 📚", "Teaching 👨‍🏫"]
    
    def skills(self):
        return {
            "Backend": ["Python 🐍", "Django 🎯", "Django REST Framework 🔌", "FastAPI ⚡"],
            "Frontend": ["HTML5 📄", "CSS3 🎨", "JavaScript 💛", "Bootstrap 🅱️"],
            "Database": ["PostgreSQL 🐘", "MySQL 🗄️", "SQLite 🪶"],
            "DevOps": ["Git 📦", "Docker 🐳", "PythonAnywhere ☁️", "Nginx 🔧"],
